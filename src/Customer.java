...
public class Customer {
    ...
    private void setDob(String date) // Date format: dd-MM-yyyy
    {
        ...
        try{
            if (dob.isBefore(earliestLegalDate)) Customer.dob = dob;
    ...
    private void setTelephone(String phone){
        try{
            if(phone.length() == 11) telephone = telephone;
    ...
    private void setName(String fullName){Customer.fullName = fullName;}
    private void setAddress1StreetNumber(String s){address[0]=s;}
    private void setAddress1StreetName(String s){address[1]=s;}
    private void setAddress1Town(String s){address[2]=s;}
    private void setAddress1PostCode(String s){address[3]=s;}
    private void setAddress2StreetNumber(String s){address2[0]=s;}
    private void setAddress2StreetName(String s){address2[1]=s;}
    private void setAddress2Town(String s){address2[2]=s;}
    private void setAddress2PostCode(String s){address2[3]=s;}
    private void setAddress3StreetNumber(String s){address3[0]=s;}
    private void setAddress3StreetName(String s){address3[1]=s;}
    private void setAddress3Town(String s){address3[2]=s;}
    private void setAddress3PostCode(String s){address3[3]=s;}

    // Methods
    public static Customer newCustomer(){
        Customer acc = new Customer(null,null,null,null,null,null,address,address2,address3);
        try{
